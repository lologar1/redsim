...
extern uint32_t RENDER_DISTANCE;
...
#define BLOCK_BOUNDINGBOX_SAFE_DISTANCE 1e-4
#define BLOCK_BOUNDINGBOX_ADJUST_OFFSET 1e-4
...
#define RSM_MAX_COMMAND_LENGTH 48
